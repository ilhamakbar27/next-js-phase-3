...
const Footer = () => {
  ...
  return (
    <footer className="text-white bg-[#191919] pb-10 px-4 py-5 font-[200] uppercase mx-auto md:px-20">
      <div className="gap-6 justify-between md:flex">
        <div className="flex-1">
          <div className="max-w-xs pt-5">
            <p className="text-lg font-[300]  tracking-wider">
              STAY IN THE KNOW
            </p>
            <p className="leading-relaxed mt-2 lowercase text-[15px]">
        ...
        <div className="flex-1 mt-10 space-y-6 items-center justify-between sm:flex md:space-y-0 md:mt-0">
          {footerNavs.map((item, idx) => (
            <ul className="space-y-4" key={idx}>
              <h4 className="text-gray-50 font-medium">{item.label}</h4>
      ...
      <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
        <div className="mt-4 sm:mt-0">
          &copy; 2024 Bite All rights reserved.
        </div>
